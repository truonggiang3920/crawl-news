package news.core.spyder.dantri;

import news.core.spyder.bao24h.Bao24hModel;
...
public class DanTriParser {
    public Bao24hModel parserDetail(String url) {
        ...
        Element pros = html.selectFirst("divNewsContent");
    ...
    public List<String> parserListLink(String url) {
        ...
        Document html = getHtmlContent(url);
        Elements elements = html.select("clearfix");
        ...
        for(int i=0; i < elements.size(); i ++){
            ...
            linkArray.add("https://dantri.com.vn/" + linkNews);
        }
        return linkArray;
    }
